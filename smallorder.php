...
var result = coffee + tea + milk;
  var reslt =(sweet1 * 35) + (sweet2 * 30) + (sweet3 * 35) + (sweet4 * 35) + (sweet5 * 50) + (snack1 * 25) + (snack2 * 25) + (snack3 * 25) + (snack4 * 35) + (snack5 * 35) + (snack6 * 25) + (snack7 * 25)+(coffee * 25) + (tea * 25) + (milk * 25);
   var bal = 1000 - reslt;
...
<div class="wrapper center-block">
  ...
  <tbody>
    <tr>
      ...
      <td>Coffee</td>
      <td>&#8377; 25</td>
      <td id="myinpc"><input type="number" class="form-control"  id="coffee" onchange="myFunction()" value="<?php echo $coffee; ?>" name="coffee"></td>
    </tr>
    <tr>
      <th scope="row"><img src="./tea.jpg" height="40px" width="40px"></th>
      <td>Tea</td>
      <td>&#8377; 25</td>
      <td id="myinpt"><input type="number" class="form-control"  id="tea" onchange="myFunction()" value="<?php echo $tea; ?>" name="tea"></td>
    </tr>
    <tr>
      <th scope="row"><img src="./milk.png" height="40px" width="40px"></th>
      <td>Milk</td>
      <td>&#8377; 25</td>
      <td id="myinpm"><input type="number" class="form-control"  id="milk" onchange="myFunction()" value="<?php echo $milk; ?>" name="milk"></td>
    </tr>
  </tbody>
</table>
</div>
...
<div id="footer" class="container footter">
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
       <h3 id="more">Add <span style="color: red;font-weight: 800;">&#8377;<span id="balance">1000</span></span>  More to Order  </h3>
